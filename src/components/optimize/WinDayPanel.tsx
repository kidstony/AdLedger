          ...
          <tbody className="divide-y divide-slate-50">
            {rows.map((l, i) => (
              <tr key={i}>
                ...
                <td className={cn('px-3 py-2 text-right font-semibold tabular-nums', positive ? 'text-green-600' : 'text-red-600')}>
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl border border-slate-200 bg-white px-4 py-3">
        <div className="mb-2 flex items-center justify-between">
          ...
          <span className="text-[10px] text-slate-400">hover xem chi tiết</span>
        </div>
