...
export function ProjectsProvider({ children }: { children: ReactNode }) {
  ...
  async function updateProject(updated: Project) {
    ...
    const { error } = await supabase
      .from('projects')
      .update({ cid: updated.cid, name: updated.name, mcc_id: updated.mcc_id, master_project_id: updated.master_project_id ?? null, screen_revenue_type: updated.screen_revenue_type ?? 'daily' })
